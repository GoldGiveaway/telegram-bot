...
import gRPC.giveaway_pb2 as giveaway__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in giveaway_pb2_grpc.py depends on'
...
def add_GreeterServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'giveaway.Greeter', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('giveaway.Greeter', rpc_method_handlers)
